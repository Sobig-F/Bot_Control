...
operations_names_block.add(plastic_casting).insert(matrix_manufacturing).insert(ED_printing).insert(mech_processing).insert(making_master_model).insert(projects_outside_tasks)
place_of_spoilage_detection.add(plastic_casting).insert(matrix_manufacturing).insert(ED_printing).insert(mech_processing).insert(b_4).insert(b_6)
